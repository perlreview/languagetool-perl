...
=for HTML <a href="https://www.github.com/perlreview/languagetool-perl/actions?query=workflow%3Amacos"><img src="https://www.github.com/perlreview/languagetool-perl/workflows/macos/badge.svg"></a>

=for HTML <a href="https://www.github.com/perlreview/languagetool-perl/actions?query=workflow%3Aubuntu"><img src="https://www.github.com/perlreview/languagetool-perl/workflows/ubuntu/badge.svg"></a>

=for HTML <a href="https://www.github.com/perlreview/languagetool-perl/actions?query=workflow%3Awindows"><img src="https://www.github.com/perlreview/languagetool-perl/workflows/windows/badge.svg"></a>

=for HTML <a href='https://ci.appveyor.com/project/briandfoy/grammarbot'><img src='https://ci.appveyor.com/api/projects/status/a?svg=true' /></a>

=for HTML <a href='https://coveralls.io/github/briandfoy/grammarbot?branch=master'><img src='https://coveralls.io/repos/github/briandfoy/grammarbot/badge.svg?branch=master' alt='Coverage Status' /></a>

=for HTML <a href="https://github.com/briandfoy/grammarbot/blob/master/LICENSE"><img src="https://img.shields.io/cpan/l/grammarbot.svg" /></a>

=for HTML <a href="https://metacpan.org/pod/GrammarBot"><img src="https://img.shields.io/cpan/v/grammarbot.svg" /></A>

=head1 The GrammarBot module

This is the I<README> for the L<GrammarBot> Perl module.
...
To read about L<GrammarBot>, look at the embedded documentation
in the module itself. Inside the distribution, you can format it
with L<perldoc|http://perldoc.perl.org/perldoc.html>:

	% perldoc lib/GrammarBot.pm
...
L<MetaCPAN|http://www.metacpan.org/module/GrammarBot>.
...
the source repository: L<https://github.com/perlreview/grammarbot>

If you find a problem, file a ticket in the L<issue
tracker|https://github.com/perlreview/grammarbot/issues>.
...
=item * L<https://bitbucket.com/briandfoy/grammarbot>

=item * L<https://codeberg.org/briandfoy/grammarbot>

=item * L<https://gitlab.com/briandfoy/grammarbot>
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify GrammarBot-1.23.tar.gz --owner briandfoy
